...
vertex gbuffer_vert_out gbuffer_vert(gbuffer_vert_in in [[stage_in]], constant type_ViewData& ViewData [[buffer(0)]], constant type_DrawData& DrawData [[buffer(1)]])
{
    gbuffer_vert_out out = {};
